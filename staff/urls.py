...
urlpatterns = [
    ...
    path(
        "create_time_table/<int:course_id>/",
        views.create_time_table,
        name="create_time_table",
    ),
    path(
        "create_time_table",
        views.create_time_table,
    ...
    path("time_table/<int:course_id>/<int:sem>/", views.time_table, name="time_table"),
    path("view_time_table/<int:course_id>/<int:sem>/<int:timetable_set_id>/", views.view_time_table, name="view_time_table"),
    path("select_timetable_set/<int:course_id>/<int:sem>/<int:timetable_set_id>/", views.select_timetable_set, name="select_timetable_set"),
    path("delete_timetable_set/<int:course_id>/<int:sem>/<int:timetable_set_id>/", views.delete_timetable_set, name="delete_timetable_set"),
    path(
        "select_course_for_timetable",
        views.select_course_for_timetable,
        name="select_course_for_timetable",
    ),
    path(
        "select_sem_for_timetable/<int:course_id>/",
