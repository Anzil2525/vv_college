...
urlpatterns = [
    ...
    path('verify_office/<int:id>/ <int:boo>/', views.verify_office, name='verify_office'),
    path('reject_staff/<int:id>/', views.reject_staff, name='reject_staff'),
    path('reject_office/<int:id>/', views.reject_office, name='reject_office'),
    ...
    path('add_minor_course/<int:id>/', views.add_minor_course, name='add_minor_course'),
    path('view_minor_course/<int:id>/', views.view_minor_course, name='view_minor_course'),
    path('del_minor_course/<int:id>/', views.del_minor_course, name='del_minor_course'),
    path('edit_minor_course/<int:id>/', views.edit_minor_course, name='edit_minor_course'),
    ...
    path('view_office_staff/', views.view_office_staff, name='view_office_staff'),
    path('view_office_staff_attendance/<int:id>/', views.view_office_staff_attendance, name='view_office_staff_attendance'),
    path('update_office_staff_attendance/<int:id>/', views.update_office_staff_attendance, name='update_office_staff_attendance'),
    path('delete_office_staff_attendance/<int:id>/<int:att_id>/', views.delete_office_staff_attendance, name='delete_office_staff_attendance'),
    path('add_holiday/', views.add_holiday, name='add_holiday'),
    path('delete_holiday/<int:id>/', views.delete_holiday, name='delete_holiday'),
    path('reset_password_of_office_staff/<int:id>/', views.reset_password_of_office_staff, name='reset_password_of_office_staff'),
    path('delete_office_staff/<int:id>/', views.delete_office_staff, name='delete_office_staff'),
    ...
    path('admin_verify_office_leave/<int:id>/', views.admin_verify_office_leave, name='admin_verify_office_leave'),
    path('admin_reject_office_leave/<int:id>/', views.admin_reject_office_leave, name='admin_reject_office_leave'),
